    ...
    <div class="row mb-5 custom-bg">
      ...
      <div class="col-12 my-5 mb-4 px-4">
        ...
        <div style="font-size: 14px;">
          ...
          <a href="rooms.php" class="text-light text-decoration-none">ROOMS</a>
        </div>
      </div>
            ...
            <?php 
              ...
              if(mysqli_num_rows($img_q)>0)
              {
                ...
                while($img_res = mysqli_fetch_assoc($img_q))
                {
                  echo"
                    <div class='carousel-item $active_class'>
                      <img src='".ROOMS_IMG_PATH.$img_res['image']."' class='d-block w-100 rounded' style='max-height: 50vh;'>
                    </div>
                  ";
                  $active_class='';
                }
                ...
                echo"<div class='carousel-item active'>
                  <img src='$room_img' class='d-block w-100' style='max-height: 50vh;'>
                </div>";
              }
      ...
      <div class="col-lg-5 col-md-12 px-4">
        <div class="card mb-4 border-0 shadow-sm rounded-3">
          <div class="card-body text-dark custom-bg">
            <?php 
              ...
              if(!$settings_r['shutdown']){
                ...
                echo<<<book
                  <button onclick='checkLoginToBook($login,$room_data[id])' class="btn w-100 text-dark bg-info shadow-none mb-1">Book Now</button>
                book;
              }
