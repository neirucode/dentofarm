  ...
  if(isset($_GET['fetch_rooms']))
  {
    ...
    while($room_data = mysqli_fetch_assoc($room_res))
    {
      ...
      if(!$settings_r['shutdown']){
        ...
        $book_btn = "<button onclick='checkLoginToBook($login,$room_data[id])' class='btn btn-sm w-100 text-dark bg-info shadow-none mb-2'>Book Now</button>";
      }

      // print room card

      $output.="
        <div class='card custom-bg mb-4 border-0 shadow  '>
          <div class='row g-0 p-3 align-items-center'>
            ...
            <div class='col-md-2 mt-lg-0 mt-md-0 mt-4 text-center'>
              ...
              $book_btn
              <a href='room_details.php?id=$room_data[id]' class='btn btn-sm w-100 btn-dark shadow-none'>More details</a>
            </div>
          </div>
        </div>
      ";
